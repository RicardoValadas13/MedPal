export const pt = {
  ...
  caregiver: {
    ...
    testCallButton: '🧪 Test Caregiver Call',
    testCallHint: 'Demo: simulates the AI agent calling the caregiver about a missed medication. Audio plays here — no real call is made.',
    testCallCalling: 'Simulating caregiver call…',
    testCallCallingTo: 'Calling',
    testCallDone: 'Caregiver notified successfully',
    testCallError: 'Could not generate the call audio. Check that the ElevenLabs key is configured.',
    testCallClose: 'Close',
